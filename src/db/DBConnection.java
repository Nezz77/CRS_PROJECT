...
public class DBConnection {
    ...
    private DBConnection() {
        try {
            ...
            this.connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/CRSDB", "root", "nesandu123");
    ...
    public Connection getConnection() {
        try {
            if (connection == null || connection.isClosed()) {
                ...
                connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/CRSDB", "root", "nesandu123");
            }
